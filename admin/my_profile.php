											...
											<div class="tab-pane fade show active" id="timeline" role="tabpanel">
												<div class="pd-20">
													...
													<div class="profile-timeline">
														...
														<?php $query = mysqli_query($conn, "SELECT * from tblleaves  ") or die(mysqli_error());
													...
													<div>
														<?php
															$data = mysqli_query($conn,"SELECT * FROM tblemployees where emp_id = '$session_id'");
															$Me = mysqli_fetch_array($data);				
														?>
														<h4 class="text-info" style="font-size: 23px;" >Available Leaves...</h4>
														<center>
															
														<h4 class="font-20 weight-500 mb-10 text-capitalize" style="font-size: 22px;" >Annual_leaves&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $Me['Av_leave']   ?></h4>
														<h4 class="font-20 weight-500 mb-10 text-capitalize" style="font-size: 22px;" >Casual_leaves&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $Me['Casual_leaves']   ?></h4>
														<h4 class="font-20 weight-500 mb-10 text-capitalize" style="font-size: 22px;" >Medical_leaves&nbsp;:&nbsp;&nbsp;<?php echo $Me['Medical_leaves']   ?></h4></center>	<br><br>		
												...
												<div class="profile-setting">
													<form method="POST" enctype="multipart/form-data">
														<div class="profile-edit-list row">
															...
															$query = mysqli_query($conn, "select * from tblemployees,company  where emp_id = '$session_id' ") or die(mysqli_error());
															$row = mysqli_fetch_array($query);
