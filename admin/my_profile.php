													...
													<div class="profile-timeline">
														...
														<div>
															...
															<center>
																...
																<h4 class="font-20 weight-500 mb-10 text-capitalize" style="font-size: 22px;">Medical_leaves&nbsp;:&nbsp;&nbsp;<?php echo $Me['Medical_leaves']   ?></h4>
															</center> <br><br>
															...
															<div class="weight-500 col-md-6">
																<div class="form-group">
																	...
																	<div class="modal-footer justify-content-center">
																		<button class="btn btn-primary" name="new_update" id="new_update" data-toggle="modal">Save &
																			&nbsp;Update</button>
																	</div>
																</div>
															</div>
