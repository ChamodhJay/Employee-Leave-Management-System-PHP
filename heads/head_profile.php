									...
									<div>
										...
										<center>
											...
											<h4 class="font-20 weight-500 mb-10 text-capitalize"
												style="font-size: 22px;">Annual_leaves&nbsp;&nbsp;:&nbsp;&nbsp;
												<?php echo $Me['Av_leave'] ?>
											</h4>
											<h4 class="font-20 weight-500 mb-10 text-capitalize"
												style="font-size: 22px;">Casual_leaves&nbsp;&nbsp;:&nbsp;&nbsp;
												<?php echo $Me['Casual_leaves'] ?>
											</h4>
											<h4 class="font-20 weight-500 mb-10 text-capitalize"
												style="font-size: 22px;">Medical_leaves&nbsp;:&nbsp;&nbsp;
												<?php echo $Me['Medical_leaves'] ?>
											</h4>
										</center> <br><br>
